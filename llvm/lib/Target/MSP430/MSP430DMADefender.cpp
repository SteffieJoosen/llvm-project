...
/// Defends against DMA attacks
    ...
    union {
      ...
      struct {
        ...
        MSP430DMADefenderPass() : MachineFunctionPass(ID) {}

        StringRef getPassName() const override { return "MSP430 DMA Defender"; }
...
char MSP430DMADefenderPass::ID = 0;

void MSP430DMADefenderPass::getAnalysisUsage(AnalysisUsage &AU) const {
...
void MSP430DMADefenderPass::AnalyzeControlFlow(MBBInfo &BBI) {
    assert(! BBI.IsDone);
...
void MSP430DMADefenderPass::RegisterDefs(MBBInfo &BBI) {
...
MSP430DMADefenderPass::MBBInfo *
MSP430DMADefenderPass::GetInfo(MachineBasicBlock &MBB) {
...
void MSP430DMADefenderPass::AnalyzeControlFlow(MachineBasicBlock &MBB) {
...
/// can be analyzed.
bool MSP430DMADefenderPass::analyzeCompare(
...
int MSP430DMADefenderPass::GetLoopTripCount(MachineLoop *L) {
...
void MSP430DMADefenderPass::AnalyzeControlFlow() {
    for (MachineBasicBlock &MBB : *MF) {
        AnalyzeControlFlow(MBB);
    }
}

void MSP430DMADefenderPass::ReAnalyzeControlFlow(MachineBasicBlock &MBB) {
    auto BBI = GetInfo(MBB);
...
void MSP430DMADefenderPass::VerifyControlFlowAnalysis() {
...
std::vector<size_t>
MSP430DMADefenderPass::GetDefs(MBBInfo *BBI, size_t RU,
                                   std::function<bool(size_t)> P) {
    std::vector<size_t> R;
...
std::vector<size_t>
MSP430DMADefenderPass::GetDefsBefore(MBBInfo *BBI, size_t RU, size_t IID) {
...
// the given instruction identifier.
std::vector<size_t>
MSP430DMADefenderPass::GetDefsAfter(MBBInfo *BBI, size_t RU, size_t IID) {
    return GetDefs(BBI, RU, [IID](size_t DIID) { return DIID > IID; });
}
...
//  this.
MachineBasicBlock * MSP430DMADefenderPass::CreateMachineBasicBlock(
...
//  made more robust and future proof as callers are probably going to forget
//  this.
MachineBasicBlock *MSP430DMADefenderPass::CloneMBB(
...
void MSP430DMADefenderPass::RemoveTerminationCode(MachineBasicBlock &MBB) {
...
void MSP430DMADefenderPass::ReplaceSuccessor(
...
static void Build_2_00_10_01(MachineBasicBlock &MBB, MachineBasicBlock::iterator I, const TargetInstrInfo *TII, Register UnusedReg) {
    DebugLoc DL;
    // MOV @RData, R3
...
static void Build_3_000_000_111(MachineBasicBlock &MBB, MachineBasicBlock::iterator I, const TargetInstrInfo *TII, Register UnusedReg) {
    DebugLoc DL;
    // MOV 2(RProgram), R3
    BuildMI(MBB, I, DL, TII->get(MSP430::MOV16rm), MSP430::CG).addReg(UnusedReg).addImm(2);
}

static void Build_3_000_101_001(MachineBasicBlock &MBB, MachineBasicBlock::iterator I, const TargetInstrInfo *TII, Register UnusedReg) {
    DebugLoc DL;
    // SWPB @RData
    BuildMI(MBB, I, DL, TII->get(MSP430::SWPB16n)).addReg(UnusedReg);
}

static void Build_3_000_001_001(MachineBasicBlock &MBB, MachineBasicBlock::iterator I, const TargetInstrInfo *TII, Register UnusedReg) {
    DebugLoc DL;
    // PUSH RUnused
    // POP RUnused
    BuildMI(MBB, I, DL, TII->get(MSP430::POP16r), MSP430::CG);
    BuildMI(MBB, I, DL, TII->get(MSP430::PUSH16r), MSP430::CG);
}

static void Build_3_000_100_000(MachineBasicBlock &MBB, MachineBasicBlock::iterator I, const TargetInstrInfo *TII, Register UnusedReg) {
    DebugLoc DL; // RET
    BuildMI(MBB, I, DL, TII->get(MSP430::RET), MSP430::CG);
}
static void Build_3_000_000_001(MachineBasicBlock &MBB, MachineBasicBlock::iterator I, const TargetInstrInfo *TII, Register UnusedReg) {
    DebugLoc DL;
    //! TODO: what to do about a BR?
    // MOV R0, RUnused
    // ADD #1, RUnused
    // BR RUnused
    BuildMI(MBB, I, DL, TII->get(MSP430::Br), UnusedReg);
    BuildMI(MBB, I, DL, TII->get(MSP430::ADD16rc), UnusedReg).addImm(1);
    BuildMI(MBB, I, DL, TII->get(MSP430::MOV16rr), UnusedReg).addReg(MSP430::PC);
}
...
static void Build_4_0001_0000_1001(MachineBasicBlock &MBB, MachineBasicBlock::iterator I, const TargetInstrInfo *TII, Register UnusedReg) {
    DebugLoc DL;
    // MOV #8, 2(RPeriph)
    BuildMI(MBB, I, DL, TII->get(MSP430::MOV16mc), UnusedReg).addImm(2).addImm(8);
}
...
static void Build_5_00000_10001_10001(MachineBasicBlock &MBB, MachineBasicBlock::iterator I, const TargetInstrInfo *TII, Register UnusedReg) {
    DebugLoc DL;
    // MOV @RData, 2(RData)
    BuildMI(MBB, I, DL, TII->get(MSP430::MOV16mn), UnusedReg).addImm(2).addReg(UnusedReg);
}

static void Build_5_00000_10000_00000(MachineBasicBlock &MBB, MachineBasicBlock::iterator I, const TargetInstrInfo *TII, Register UnusedReg) {
    DebugLoc DL;// RETI
    BuildMI(MBB, I, DL, TII->get(MSP430::RETI), MSP430::CG);
}

static void Build_6_000000_010101_110001(MachineBasicBlock &MBB, MachineBasicBlock::iterator I, const TargetInstrInfo *TII, Register UnusedReg) {
    DebugLoc DL;
    // ADD 2(RData), 2(RData)
    BuildMI(MBB, I, DL, TII->get(MSP430::ADD16mm), UnusedReg)
            .addImm(2)
            .addReg(UnusedReg)
            .addImm(2);
}

static void Build_6_000000_010001_110001(MachineBasicBlock &MBB, MachineBasicBlock::iterator I, const TargetInstrInfo *TII, Register UnusedReg) {
    DebugLoc DL;
    // MOV 2(RData), 2(RData)
    BuildMI(MBB, I, DL, TII->get(MSP430::MOV16mm), UnusedReg)
            .addImm(2)
            .addReg(UnusedReg)
            .addImm(2);
}

static void Build_6_000000_000101_111001(MachineBasicBlock &MBB, MachineBasicBlock::iterator I, const TargetInstrInfo *TII, Register RData, Register RProgram) {
    DebugLoc DL;
...
static void Build_6_000000_000001_111001(MachineBasicBlock &MBB, MachineBasicBlock::iterator I, const TargetInstrInfo *TII, Register RData, Register RProgram) {
    DebugLoc DL;
    // MOV 2(RProgram), 2(RData)
    BuildMI(MBB, I, DL, TII->get(MSP430::MOV16mm), RData)
            .addImm(2)
            .addReg(RProgram)
            .addImm(2);
...
StringRef MSP430DMADefenderPass::CheckAccessedMemoryRegionsInstr(MachineInstr &MI) {
    ...
    auto num_memoper = MI.getNumMemOperands();
    auto num_oper = MI.getNumOperands();
    switch (num_memoper) {
        case 0:
            if (MI.getOperand(num_oper - 2).isReg()) {
                if (MI.getOperand(num_oper - 1).isReg()) {
...
void MSP430DMADefenderPass::BuildFingerprint(
...
std::vector<MachineBasicBlock *>
MSP430DMADefenderPass::GetFingerprint(MachineLoop *L) {
    std::vector<MachineBasicBlock *> Result;
    BuildFingerprint(L, Result);
    return Result;
}

bool MSP430DMADefenderPass::IsTwoWayBranch(MBBInfo *BBI) {
    bool result = false;
...
void MSP430DMADefenderPass::AlignTwoWayBranch(MachineBasicBlock &MBB) {
    DebugLoc DL; // FIXME: Where to get DebugLoc from?
...
//   method.
MSP430DMADefenderPass::Successors
MSP430DMADefenderPass::ComputeSuccessors(
                    ...
                    if ( (R.Loop == nullptr) || (S != R.Loop->getHeader()) ) {
                        ...
                        if (S == Exit) {
                            ...
                            if (KV != Clones.end()) {
                                ...
                                //         MSP430DMADefenderPass::ReplaceSuccessor()::4
                    ...
                    if (BB != Ref) {
                        ...
                        if (MII[BB] == BB->end()) {
                            ...
                            if (RITr != MITr) {
                                ...
                                LLVM_DEBUG(dbgs() << "memtraces match");
                                MII[BB]++;
                            }
                        }
                        LLVM_DEBUG(dbgs() << "\n");
...
void MSP430DMADefenderPass::CanonicalizeTerminatingInstructions(
...
bool MSP430DMADefenderPass::addDependency(MachineInstr *MI,
                                              MachineBasicBlock *MBB,
                                              std::vector<size_t> &Defs) {
    if (! Defs.empty()) {
...
void MSP430DMADefenderPass::ComputeDependencies(
...
//  is enough to implement the DMA defense.
void MSP430DMADefenderPass::ComputeReachingDefs() {
...
bool MSP430DMADefenderPass::IsSecretDependent(MachineInstr *MI) {
    return SensitivityInfo.find(MI) != SensitivityInfo.end();
}

bool MSP430DMADefenderPass::IsSecretDependent(MBBInfo *BBI) {
    return BBI->HasSecretDependentBranch;
}

// Marks the given machine instruction as sensitive
void MSP430DMADefenderPass::Taint(MachineInstr * MI) {
...
bool
MSP430DMADefenderPass::IsPartOfSensitiveRegion(const MachineInstr *MI) {
    bool Result = false;
...
void MSP430DMADefenderPass::PerformSensitivityAnalysis() {
    size_t N = 0;
...
bool MSP430DMADefenderPass::MatchFork(MBBInfo &EBBI) {
...
bool MSP430DMADefenderPass::MatchTriangle(MBBInfo &EBBI, bool DivOnFalse) {
...
//
// !TODO: Generalize the triangle pattern
bool MSP430DMADefenderPass::MatchDiamond(MBBInfo &EBBI) {
  return false;
}
...
void MSP430DMADefenderPass::ClassifyBranches() {
  for (auto &&KV : BBAnalysis) {
    MBBInfo &BBI = KV.second;
...
void MSP430DMADefenderPass::CompensateInstr(const MachineInstr &MI,
    ...
    switch (instr_class) {
        case 10:
            Build_1_0_0_1(MBB, I, TII, RData);
            break;
        case 20:
            Build_2_00_00_11(MBB, I, TII, RData);
            break;
        case 21:
            Build_2_00_10_01(MBB, I, TII, RData);
            break;
        case 30:
            Build_3_000_010_101(MBB, I, TII, RData);
            break;
        case 31:
            Build_3_000_101_001(MBB, I, TII, RData);
            break;
        case 32:
            Build_3_000_001_001(MBB, I, TII, RData);
            break;
        case 33:
            Build_3_000_100_000(MBB, I, TII, RData);
            break;
        case 34:
            Build_3_000_000_001(MBB, I, TII, RData);
            break;
        case 35:
            Build_3_000_000_111(MBB, I, TII, RProgram);
            break;
        case 40:
            Build_4_0000_0101_1001(MBB, I, TII, RData);
            break;
        case 41:
            Build_4_0000_0001_1001(MBB, I, TII, RData);
            break;
        case 50:
            Build_5_00000_00101_11001(MBB, I, TII, RData);
            break;
        case 51:
            Build_5_00000_10101_10001(MBB, I, TII, RData);
            break;
        case 52:
            Build_5_00000_00001_11001(MBB, I, TII, RData);
            break;
        case 53:
            Build_5_00000_10001_10001(MBB, I, TII, RData);
            break;
        case 54:
            Build_5_00000_10000_00000(MBB, I, TII, RData);
            break;
        case 60:
            Build_6_000000_010101_110001(MBB, I, TII, RData);
            break;
        case 61:
            Build_6_000000_010001_110001(MBB, I, TII, RData);
            break;
        case 660:
            Build_6_000000_000101_111001(MBB, I, TII, RData, RProgram);
            break;
        case 661:
...
//  the callee
void MSP430DMADefenderPass::CompensateCall(const MachineInstr &Call,
                                               MachineBasicBlock &MBB,
                                               MachineBasicBlock::iterator I) {
    DebugLoc DL; // FIXME: Where to get DebugLoc from?
...
#if 0
bool
MSP430DMADefenderPass::IsEnryOfPattern(MBBInfo &BBI, BranchClass BClass) {
...
MSP430DMADefenderPass::AlignBlock(MachineBasicBlock &Source,
                                      MachineBasicBlock::iterator SI,
                                      MachineBasicBlock &Target,
                                      MachineBasicBlock::iterator TI) {
...
MachineBasicBlock::iterator MSP430DMADefenderPass::
...
void MSP430DMADefenderPass::AlignDiamond(MBBInfo &EBBI) {
}

void MSP430DMADefenderPass::AlignFork(MBBInfo &EBBI) {
...
void MSP430DMADefenderPass::AlignTriangle(MBBInfo &EBBI) {
  ...
  for (auto &MI : *T.DivBB) {
    CompensateInstr(MI, *NewBB, NewBB->end(), MSP430::R4, MSP430::R5, MSP430::R6);
  }
  ...
  //        for the DMA defense to work properly (check that this is the
  //        case)
...
//  region.
MachineBasicBlock *
MSP430DMADefenderPass::GetExitOfSensitiveBranch(MachineBasicBlock *Entry) {
...
//   - dummy exit
//   - dummy latch
void MSP430DMADefenderPass::CanonicalizeSensitiveLoop(MachineLoop *Loop) {
...
void MSP430DMADefenderPass::AlignContainedRegions(MachineLoop *Loop)
{
    auto Header = Loop->getHeader();
    assert(Header != nullptr);
            ...
            if (L == Loop) {
                if (IsSecretDependent(&BBI)) {
                    ...
                    if (UnusedRegs.size() >= 3 && CheckAccessedMemoryRegions(Succs.Succs, TII)) {
                        ...
                        // PUSH RPeriph
                        BuildMI(*(BBI.BB), --I, BBI.BB->findDebugLoc(BBI.BB->end()),
                                TII->get(MSP430::PUSH16r), UnusedRegs[2]);
                        // MOV #0xFFDC, RProgram
                        BuildMI(*(BBI.BB), --I, BBI.BB->findDebugLoc(BBI.BB->end()),
                                TII->get(MSP430::MOV16rc), UnusedRegs[1]).addImm(0xFFDC);
                        // PUSH RProgram
                        BuildMI(*(BBI.BB), --I, BBI.BB->findDebugLoc(BBI.BB->end()),
                                TII->get(MSP430::PUSH16r), UnusedRegs[1]);
                        // MOV #0x0402, RData
                        BuildMI(*(BBI.BB), --I, BBI.BB->findDebugLoc(BBI.BB->end()),
                                TII->get(MSP430::MOV16rc), UnusedRegs[0]).addImm(0x0402);
                        // PUSH RData
                        BuildMI(*(BBI.BB), --I, BBI.BB->findDebugLoc(BBI.BB->end()),
                                TII->get(MSP430::PUSH16r), UnusedRegs[0]);
...
std::vector<MachineBasicBlock *>
MSP430DMADefenderPass::AlignFingerprint(
...
// Remark: Recomputes analysis passes
std::vector<MachineBasicBlock *>
MSP430DMADefenderPass::AlignSensitiveLoop(MachineLoop *Loop,
...
void MSP430DMADefenderPass::RedoAnalysisPasses() {
...
std::vector<Register> MSP430DMADefenderPass::FindUnusedRegisters(std::vector<MachineBasicBlock *> BBs) {
    ...
    for (MachineBasicBlock *BB : BBs){
        for (auto it = BB->instr_begin(); it != BB->instr_end(); ++it ) {
            std::pair<bool,bool> testR4 = (*it).readsWritesVirtualRegister(MSP430::R4);
            std::pair<bool,bool> testR5 = (*it).readsWritesVirtualRegister(MSP430::R5);
            std::pair<bool,bool> testR6 = (*it).readsWritesVirtualRegister(MSP430::R6);
            std::pair<bool,bool> testR7 = (*it).readsWritesVirtualRegister(MSP430::R7);
            std::pair<bool,bool> testR8 = (*it).readsWritesVirtualRegister(MSP430::R8);
            std::pair<bool,bool> testR9 = (*it).readsWritesVirtualRegister(MSP430::R9);
            std::pair<bool,bool> testR10 = (*it).readsWritesVirtualRegister(MSP430::R10);
            std::pair<bool,bool> testR11 = (*it).readsWritesVirtualRegister(MSP430::R11);
            std::pair<bool,bool> testR12 = (*it).readsWritesVirtualRegister(MSP430::R12);
            std::pair<bool,bool> testR13 = (*it).readsWritesVirtualRegister(MSP430::R13);
            std::pair<bool,bool> testR14 = (*it).readsWritesVirtualRegister(MSP430::R14);
            std::pair<bool,bool> testR15 = (*it).readsWritesVirtualRegister(MSP430::R15);
            if (testR4.first || testR4.second) {
                used[0] = true;
            } else if (testR5.first || testR5.second) {
                used[1] = true;
            } else if (testR6.first || testR6.second) {
                used[2] = true;
            } else if (testR7.first || testR7.second) {
                used[3] = true;
            } else if (testR8.first || testR8.second) {
                used[4] = true;
            } else if (testR9.first || testR9.second) {
                used[5] = true;
            } else if (testR10.first || testR10.second) {
                used[6] = true;
            } else if (testR11.first || testR11.second) {
                used[7] = true;
            } else if (testR12.first || testR12.second) {
                used[8] = true;
            } else if (testR13.first || testR13.second) {
                used[9] = true;
            } else if (testR14.first || testR14.second) {
                used[10] = true;
            } else if (testR15.first || testR15.second) {
                used[11] = true;
            }
        }
    }
    for (int i = 0; i < 12; i++){
        if (!used[i]) unused_regs.push_back(regs[i]);
    }
    return unused_regs;
}
...
void MSP430DMADefenderPass::AnalyzeLoops() {
    for (auto &KV : BBAnalysis) {
        MBBInfo &BBI = KV.second;
...
void MSP430DMADefenderPass::DetectOuterSensitiveBranches() {
...
void MSP430DMADefenderPass::SecureCall(MachineInstr &Call) {
    DebugLoc DL; // FIXME: Where to get DebugLoc from?
...
void MSP430DMADefenderPass::SecureCalls() {
    for (auto &&KV : BBAnalysis) {
        MBBInfo &BBI = KV.second;
        if (BBI.IsPartOfSensitiveRegion) {
            for (auto &MI : *BBI.BB) {
...
void MSP430DMADefenderPass::AlignSensitiveBranches() {
    //MF->viewCFG();
        ...
        if (IsSecretDependent(&BBI) && (! BBI.IsPartOfSensitiveRegion) ) {
            ...
            if (UnusedRegs.size() >= 3 && CheckAccessedMemoryRegions(Succs.Succs, TII)) {
                ...
                BuildMI(*(BBI.BB), --I, BBI.BB->findDebugLoc(BBI.BB->end()),
                        TII->get(MSP430::MOV16rc), UnusedRegs[1]).addImm(0xFFDC);
                // PUSH RProgram
                BuildMI(*(BBI.BB), --I, BBI.BB->findDebugLoc(BBI.BB->end()), TII->get(MSP430::PUSH16r), UnusedRegs[1]);
                // MOV #0x0402, RData
                BuildMI(*(BBI.BB), --I, BBI.BB->findDebugLoc(BBI.BB->end()),
                        TII->get(MSP430::MOV16rc), UnusedRegs[0]).addImm(0x0402);
                // PUSH RData
...
#if 0
void MSP430DMADefenderPass::DumpDebugInfo() {
...
void MSP430DMADefenderPass::WriteCFG(std::string label)
{
#if !defined(NDEBUG)
    if (SaveCFG) {
...
void MSP430DMADefenderPass::DumpCFG() {
...
void MSP430DMADefenderPass::PrepareAnalysis() {
    MF->RenumberBlocks();
#if 0  // Re-enable when BBAnalysis is a vector
    ...
    for (auto &Arg : MF->getFunction().args()) {
        ...
        assert(!Arg.hasByRefAttr() && "no pointers as arguments supported");
        assert(!Arg.hasPreallocatedAttr() && "no pointers as arguments supported");


    }
}

void MSP430DMADefenderPass::FinishAnalysis() {
...
void MSP430DMADefenderPass::CanonicalizeCFG() {
    if (CanonicalExit != nullptr) {
...
bool MSP430DMADefenderPass::runOnMachineFunction(MachineFunction &MF) {
...
void MSP430DMADefenderPass::releaseMemory() {
...
#if 0
INITIALIZE_PASS_BEGIN(MSP430DMADefenderPass, DEBUG_TYPE,
                      "X86 cmov Conversion", false, false)
INITIALIZE_PASS_DEPENDENCY(MachineLoopInfo)
INITIALIZE_PASS_END(MSP430DMADefenderPass, DEBUG_TYPE,
                    "X86 cmov Conversion", false, false)
#endif
static RegisterPass<MSP430DMADefenderPass> X(DEBUG_TYPE,
                                                 "MSP430 DMA Defender Pass",
